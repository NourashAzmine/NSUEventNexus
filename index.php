...
$stmt = $conn->prepare("SELECT eventID, eventName, eventDetails, date, registrationDeadline, bannerURL FROM events WHERE status = 'approved' ORDER BY date ASC");
$stmt->execute();
...
<body>
    ...
    <header class="header">
        <div class="banner-slider">
            <div class="banner-slide" style="background-image: url('images/banner.png');"></div>
        </div>
    </header>
    ...
    <section class="upcoming-events">
        <div class="container">
            <h2>Upcoming Events And Seminars</h2>
            <?php
    ...
    <section class="about">
        <div class="container">
            <h2>About Us</h2>
            <p>NSU Event Nexus is the central platform for all events happening at North South University. From academic seminars to cultural festivals, find all the details and stay updated with the latest events.</p>
        </div>
    </section>
